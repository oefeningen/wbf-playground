  ...
  <div>
    <leegKader4 :strookId="props.strookId" :oefenvormen="props.oefenvormen">
      ...
      <template #oefening>
        ...
        <getalBeeld term1="1" term2="2" />
        <getalbeeldFiguur term1="1" term2="2" />
        <div row>hier zie je de oefening {{ generatieId }}</div>
      </template>
    </leegKader4>
  </div>
</template>
...
import getalBeeld from './getalBeeld.vue';
import getalbeeldFiguur from './getalbeeldFiguur.vue';
