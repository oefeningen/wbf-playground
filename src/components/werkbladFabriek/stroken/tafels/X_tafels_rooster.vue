    ...
    <div slot="oefening">
        <oefeningtitel :toonTitel="toonTitel">Tafelsporen</oefeningtitel>
         <div class="fit row justify-around">
           ...
           <rooster ref="spoor1" :geselecteerdeTafels="geselecteerdeTafels"  :toonOplossing="toonOplossing"></rooster>
            <rooster ref="spoor2" :geselecteerdeTafels="geselecteerdeTafels"  :toonOplossing="toonOplossing"></rooster>
           <rooster ref="spoor3" :geselecteerdeTafels="geselecteerdeTafels"  :toonOplossing="toonOplossing"></rooster>
