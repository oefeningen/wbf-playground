<template>
  <div>
    <div class="tafelspoor_titeldiv">
      <p class="tafelspoor_titel">
        <b>Kleur het tafelspoor van {{ tafel }}</b>
      </p>
    </div>
    <table>
      <tr>
