...
export default {
  components: {
    paginaHoofding:
      require('components/werkbladfabriek/vaste_layout/PaginaHoofding').default,
    paginaFooter:
      require('components/werkbladfabriek/vaste_layout/PaginaFooter').default,
    leegKader: require('components/werkbladfabriek/vaste_layout/leegKader4')
      .default,
    knoppenrij: require('components/werkbladfabriek/vaste_layout/knoppenrij')
      .default,
  },
  props: ['map'],
  computed: {
