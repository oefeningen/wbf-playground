...
export default {
  components: {
    ...
    werkblad: require('components/werkbladfabriek/vaste_layout/Pagina_drill')
      .default,
    instellingen:
      require('components/werkbladfabriek/stroken/tot10getalbeeld/instellingen')
        .default,
    oefening:
      require('components/werkbladfabriek/stroken/tot10getalbeeld/oefening')
        .default,
  },
  mixins: [paginaMix],
  methods: {},
